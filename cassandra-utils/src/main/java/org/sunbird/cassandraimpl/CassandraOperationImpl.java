...
public abstract class CassandraOperationImpl implements CassandraOperation {
    ...
    private Response getRecordByIdentifier(
            String keyspaceName, String tableName, Object key, List<String> fields) throws BaseException{
        long startTime = System.currentTimeMillis();
        logger.info(
    ...
    @Override
    public Response getRecordById(String keyspaceName, String tableName, String key) throws BaseException {
        return getRecordByIdentifier(keyspaceName, tableName, key, null);
    }

    @Override
    public Response getRecordById(String keyspaceName, String tableName, Map<String, Object> key) throws BaseException  {
        return getRecordByIdentifier(keyspaceName, tableName, key, null);
    }

    @Override
    public Response getRecordById(
            String keyspaceName, String tableName, String key, List<String> fields) throws BaseException  {
    ...
    public Response batchUpdateById(
        ...
        long startTime = System.currentTimeMillis();
        logger.info(
                "Cassandra Service batchUpdateById method started at == {}", startTime);
        Session session = connectionManager.getSession(keyspaceName);
        Response response = new Response();
        BatchStatement batchStatement = new BatchStatement();
        ResultSet resultSet = null;
    ...
    public Response performBatchAction(
        ...
        try {
            ...
            response.put(Constants.RESPONSE, Constants.SUCCESS);
                ...
                | IllegalStateException e) {
            logger.error(
                    "Cassandra performBatchAction Failed." + e.getMessage());
            throw new BaseException(
                    IResponseMessage.SERVER_ERROR,
                    IResponseMessage.SERVER_ERROR,
                    ResponseCode.SERVER_ERROR.getCode());
    ...
    public Response batchUpdate(
            String keyspaceName, String tableName, List<Map<String, Map<String, Object>>> list) throws BaseException {
    ...
    public Response getRecordsByPrimaryKeys(
            ...
            String primaryKeyColumnName) throws BaseException{
        long startTime = System.currentTimeMillis();
        logger.info(
    ...
    public Response batchInsertWithTTL(
            ...
            List<Integer> ttls) throws BaseException{
        long startTime = System.currentTimeMillis();
        logger.info(
                "CassandraOperationImpl:batchInsertWithTTL: call started at " + startTime);
    ...
    @Override
    public Response searchValueInList(String keyspace, String tableName, String key, String value) throws BaseException {
    ...
    public Response searchValueInList(
            ...
            String key,
            String value,
            Map<String, Object> propertyMap) throws BaseException {
